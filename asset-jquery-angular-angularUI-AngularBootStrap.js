...
(function(M, T, p) {
    ...
    a) {
        ...
        n(d, function(a) {
            if (!e) {
                ...
                b ? (e = a, g = (b[2] || "")
                    .replace(/\s+/g, ",")) : n(a.attributes, function(b) {
        ...
        function c() {
            ...
            for (var b = [this], c = a, i, f, h, j, m, k; b.length;) {
                ...
                for (h = i.length; f < h; f++) {
                    ...
                    m = 0;
                    for (e = (k = j.children())
                        .length, j = e; m < j; m++) b.push(ga(k[m]))
                }
            }
    ...
    function Hb(b) {
        ...
        if (typeof b == "function") {
            if (!(a = b.$inject)) a = [], c = b.toString()
                .replace(yc, ""), c = c.match(zc), n(c[1].split(Ac), function(b) {
        ...
        function g(a, b) {
            ...
            return {
                ...
                instantiate: function(a, b) {
                    var c = function() {}, e;
                    c.prototype = (F(a) ? a[a.length - 1] : a)
                        .prototype;
                    c = new c;
                    e = d(a, c, b);
                    return L(e) ? e : c
    ...
    function Dc(b, a, c, d) {
        ...
        f.onUrlChange = function(a) {
            A || (d.history && w(b)
                .bind("popstate", i), d.hashchange ? w(b)
                .bind("hashchange", i) : f.addPollFn(i), A = !0);
            v.push(a);
            return a
        };
        f.baseHref = function() {
        ...
        f.cookies = function(a, b) {
            ...
            if (a) if (b === p) h.cookie = escape(a) + "=;path=" + $ + ";expires=Thu, 01 Jan 1970 00:00:00 GMT";
                ...
                if (E(b)) d = (h.cookie = escape(a) + "=" + escape(b) + ";path=" + $)
    ...
    function Jb(b) {
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", function(b, j, m, k, l, u, o, z, r) {
            function y(a, b, c) {
                ...
                n(a, function(b, c) {
                    b.nodeType == 3 && b.nodeValue.match(/\S+/) && (a[c] = w(b)
                        .wrap("<span></span>")
                        .parent()[0])
                });
                var d = W(a, b, a, c);
                return function(b, c) {
                    ...
                    for (var e = c ? Ba.clone.call(a) : a, j = 0, g = e.length; j < g; j++) {
                        var h = e[j];
                        (h.nodeType == 1 || h.nodeType == 9) && e.eq(j)
                            .data("$scope", b)
                    }
                    x(e, "ng-scope");
                    c && c(e, b);
            ...
            function W(a, b, c, d) {
                function e(a, c, d, g) {
                    ...
                    u = o = 0;
                    for (m = j.length; o < m; u++) i = z[u], c = j[o++], h = j[o++], c ? (c.scope ? (k = a.$new(L(c.scope)), w(i)
                        .data("$scope", k)) : k = a, (l = c.transclude) || !g && b ? c(h, k, i, d, function(b) {
                        return function(c) {
                            var d = a.$new();
                            d.$$transcluded = !0;
                            return b(d, c)
                                .bind("$destroy", $a(d, d.$destroy))
                        }
            ...
            function v(a, b, c, j) {
                ...
                case 1:
                    ...
                    var i, k, l;
                    h = a.attributes;
                    for (var o = 0, m = h && h.length; o < m; o++) if (i = h[o], i.specified) k = i.name, l = da(k), Y.test(l) && (k = l.substr(6)
                        .toLowerCase()), l = da(k.toLowerCase()), g[l] = k, c[l] = i = U(Z && k == "href" ? decodeURIComponent(a.getAttribute(k, 2)) : i.value), Fb(a, l) && (c[l] = !0), s(a, b, i, l), G(b, l, "A", j);
                    a = a.className;
            ...
            function A(a, b, c, d, e) {
                ...
                for (var l = -Number.MAX_VALUE, z = [], ea = [], r = null, K = null, W = null, J = c.$$element = w(b), s, A, Y, G, P = d, q, na, t, B = 0, C = a.length; B < C; B++) {
                    ...
                    if (t = s.transclude) O("transclusion", G, s, J), G = s, l = s.priority, t == "element" ? (Y = w(b), J = c.$$element = w(T.createComment(" " + A + ": " + c[A] + " ")), b = J[0], ja(e, w(Y[0]), b), P = y(Y, d, l)) : (Y = w(fb(b))
                        .contents(),
                    J.html(""), P = y(Y, d));
            ...
            function s(a, b, c, d) {
                ...
                e && b.push({
                    ...
                    compile: S(function(a, b, c) {
                        ...
                        if (e = j(c[d], !0)) c[d] = e(a), (b[d] || (b[d] = []))
                            .$$inter = !0, (c.$$observers && c.$$observers[d].$$scope || a)
                            .$watch(e, function(a) {
                            c.$set(d,
                            a)
                        })
    ...
    function Nc() {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", function(c, d, e, g) {
            ...
            d.onUrlChange(function(a) {
                f.absUrl() != a && (c.$broadcast("$locationChangeStart", a, f.absUrl())
                    .defaultPrevented ? d.url(f.absUrl()) : (c.$evalAsync(function() {
                    var b = f.absUrl();
                    f.$$parse(a);
                    i(b)
                }), c.$$phase || c.$digest()))
    ...
    function Vc() {
        ...
        this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$http", "$templateCache", function(a, c, d, e, g, i, f) {
            ...
            function j() {
                ...
                j);
                else if (b || j) l = !1, a.$broadcast("$routeChangeStart", b, j), (u.current = b) && b.redirectTo && (E(b.redirectTo) ? c.path(k(b.redirectTo, b.params))
                    .search(b.params)
    ...
    function Yc() {
        this.$get = ["$window", "$document", function(b, a) {
            var c = {}, d = N((/android (\d+)/.exec(I((b.navigator || {})
                .userAgent)) || [])[1]),
    ...
    function $b(b) {
        ...
        d) {
            ...
            return dc(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2)
                .replace(/\u00A4/g, d)
        }
    }
    function bc(b) {
    ...
    var sc = /[A-Z]/g,
        ...
        }, Ka = R.cache = {}, Ja = R.expando = "ng-" + (new Date)
            .getTime(),
        wc = 1,
        ...
        Ba = R.prototype = {
            ready: function(b) {
                ...
                var c = !1;
                T.readyState === "complete" ? setTimeout(a) : (this.bind("DOMContentLoaded", a), R(M)
                    .bind("load", a))
            },
            toString: function() {
                var b = [];
    ...
    n({
        ...
        attr: function(b, a, c) {
            ...
            else return b[a] || (b.attributes.getNamedItem(a) || q)
                .specified ? d : p;
                ...
                function j(j, k, o) {
                    return function(m, r, p) {
                        ...
                        if (w) {
                            ...
                            if (!g.transitions && !A && !$ || (r.inheritedData(a) || q)
                                .running) k(m, r, p), o(m, r, p);
                            else {
                                var O = m.data(a) || {};
                    ...
                    return function(f, i, n) {
                        ...
                        f.$watch(h, function(g) {
                            ...
                            g ? (a.get(g, {
                                ...
                                .success(function(a) {
                                h === p && (r && r.$destroy(), r = f.$new(), o.leave(i.contents(), i), a = w("<div/>")
                                    .html(a)
                                    .contents(),
                    ...
                    function k() {
                        ...
                        if (k) {
                            ...
                            var k = g(k),
                                m = d.current;
                            l = m.scope = a.$new();
                            if (m.controller) f.$scope = l, f = i(m.controller, f), m.controllerAs && (l[m.controllerAs] = f), c.children()
            ...
            return {
                ...
                compile: function(d, e) {
                    ...
                    return function(a, d, e) {
                        var j = d.parent(),
                            m = j.data("$selectController") || j.parent()
...
function() {
    ...
    .directive("collapse", ["$transition", function(t) {
    ...
    .controller("CarouselController", ["$scope", "$timeout", "$transition", "$q", function(t, e, n) {
    function o() {
        function n() {
            i ? (t.next(), o()) : t.pause()
        }
...
dialogModule.controller("MessageBoxController", ["$scope", "dialog", "model", function(t, e, n) {
    ...
    this.options = function(t) {
        ...
        return f.prototype.isOpen = function() {
            ...
            if (g.removeClass(o.options.dialogOpenClass), a.length > 0) for (var i = a.length - 1; i >= 0; i--) u(a[i], e)
                .then(n);
            ...
            }), n.push("$template"), e.push(t), c.all(e)
                .then(function(t) {
                var e = {};
    ...
    .directive("dropdownToggle", ["$document", "$location", "$window", function(t) {
    var e = null,
        n = angular.noop;
    return {
        restrict: "CA",
        link: function(o, a) {
            o.$watch("$location.path", function() {
                ...
                var i = a === e;
                e && n(), i || (a.parent()
                    .addClass("open"), e = a, n = function(o) {
                    o && (o.preventDefault(), o.stopPropagation()), t.unbind("click", n), a.parent()
                        .removeClass("open"), n = angular.noop, e = null
                }, t.bind("click", n))
            })
        }
    }
}]), angular.module("ui.bootstrap.modal", ["ui.bootstrap.dialog"])
    .directive("modal", ["$parse", "$dialog", function(t, e) {
    return {
        restrict: "EA",
        terminal: !0,
        link: function(n, o, a) {
    ...
    .factory("$position", ["$document", "$window", function(t, e) {
    function n(t, n) {
    ...
    .controller("TabsController", ["$scope", "$element", function(t) {
    var e = t.panes = [];
    ...
    .factory("typeaheadParser", ["$parse", function(t) {
...
}]), angular.module("template/typeahead/match.html", [])
    .run(["$templateCache", function(t) {
...
*/! function(e) {
    ...
    }, e.fn.alert.Constructor = n, e(document)
    ...
    t.prototype.setState = function(e) {
        ...
        loadingText: "loading..."
    }, e.fn.button.Constructor = t, e(document)
    ...
    "use strict";
    var t = function(t, n) {
        this.$element = e(t), this.options = n, this.options.slide && this.slide(this.options.slide), this.options.pause == "hover" && this.$element.on("mouseenter", e.proxy(this.pause, this))
    ...
    t.prototype = {
        ...
        to: function(t) {
            ...
            return this.sliding ? this.$element.one("slid", function() {
                ...
                .cycle() : this.slide(t > i ? "next" : "prev", e(r[t]))
        },
        pause: function(t) {
            return t || (this.paused = !0), this.$element.find(".next, .prev")
                .length && e.support.transition.end && (this.$element.trigger(e.support.transition.end), this.cycle()), clearInterval(this.interval), this.interval = null, this
        },
        next: function() {
        ...
        interval: 5e3,
        pause: "hover"
    }, e.fn.carousel.Constructor = t, e(document)
        .on("click.carousel.data-api", "[data-slide]", function(t) {
        var n = e(this),
    ...
    t.prototype = {
        ...
        toggle: !0
    }, e.fn.collapse.Constructor = t, e(document)
    ...
    n.prototype = {
        ...
        keydown: function(t) {
            ...
            if (!r.length) return;
            a = r.index(r.filter(":focus")), t.keyCode == 38 && a > 0 && a--, t.keyCode == 40 && a < r.length - 1 && a++, ~a || (a = 0), r.eq(a)
                .focus()
        }
    ...
    }, e.fn.dropdown.Constructor = n, e(document)
    ...
    t.prototype = {
        ...
        backdrop: function(t) {
            ...
            if (this.isShown && this.options.backdrop) {
                ...
                this.$backdrop = e('<div class="modal-backdrop ' + r + '" />')
                    .appendTo(document.body), this.$backdrop.click(this.options.backdrop == "static" ? e.proxy(this.$element[0].focus, this.$element[0]) : e.proxy(this.hide, this)), i && this.$backdrop[0].offsetWidth, this.$backdrop.addClass("in"), i ? this.$backdrop.one(e.support.transition.end, t) : t()
        ...
        keyboard: !0,
        show: !0
    }, e.fn.modal.Constructor = t, e(document)
    ...
    t.prototype = {
        ...
        show: function() {
            ...
            if (this.hasContent() && this.enabled) {
                e = this.tip(), this.setContent(), this.options.animation && e.addClass("fade"), s = typeof this.options.placement == "function" ? this.options.placement.call(this, e[0], this.$element[0]) : this.options.placement, t = /in/.test(s), e.detach()
                    .css({
                    top: 0,
                    left: 0,
                    display: "block"
    ...
    }, e.fn.tab.Constructor = t, e(document)
    ...
    "use strict";
    var t = function(t, n) {
        this.$element = e(t), this.options = e.extend({}, e.fn.typeahead.defaults, n), this.matcher = this.options.matcher || this.matcher, this.sorter = this.options.sorter || this.sorter, this.highlighter = this.options.highlighter || this.highlighter, this.updater = this.options.updater || this.updater, this.$menu = e(this.options.menu)
    ...
    t.prototype = {
        ...
        item: '<li><a href="#"></a></li>',
        minLength: 1
    }, e.fn.typeahead.Constructor = t, e(document)
